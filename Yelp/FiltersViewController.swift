...
class FiltersViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate{
    ...
    override func didReceiveMemoryWarning() {
     ...
     func switchCell(switchCell: SwitchCell, didChangeValue value: Bool) {
        NSLog("Controller received message that switch was flipped")
        var indexPath: NSIndexPath = self.tableView.indexPathForCell(switchCell)!
    ...
    func onApplyButton() {
        ...
        delegate?.filtersViewController(self, didChangeFilters: self.filters)
        self.dismissViewControllerAnimated(true, completion: nil)
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
     switch (indexPath.section) {
        case 0:
            ...
            cell.switchLabel.text = self.deals![indexPath.row]["label"] as? NSString
        ...
        case 1:
            // Section 1: distance
            let cell:SwitchCell = tableView.dequeueReusableCellWithIdentifier("SwitchCell") as SwitchCell
            cell.switchLabel.text = self.distances![indexPath.row]["label"] as? NSString
        ...
        case 2:
            // Section 2: sort
            let cell:SwitchCell = tableView.dequeueReusableCellWithIdentifier("SwitchCell") as SwitchCell
            cell.switchLabel.text = self.sortingMethods![indexPath.row]["label"] as? NSString
        ...
        case 3:
            // Section 3: categories
            let cell:SwitchCell = tableView.dequeueReusableCellWithIdentifier("SwitchCell") as SwitchCell
            cell.switchLabel.text = self.categories![indexPath.row]["name"] as? NSString
